      ...
      <section className="relative mb-20 sm:mb-32">
        <div className="hero-glow" />
          ...
          <div className="lg:max-w-2xl">
            ...
            <div className="hero-animate flex flex-col sm:flex-row gap-3 mt-2" style={{ animationDelay: "180ms" }}>
              <a href="https://agent.occ.wtf/auth/login/github"
                className="inline-flex items-center justify-center gap-2.5 rounded-full bg-bg-elevated border border-border-subtle px-5 py-2.5 text-sm font-medium text-text-secondary hover:text-text hover:border-border transition-all">

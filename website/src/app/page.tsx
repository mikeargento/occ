...
export default function OCCPage() {
  ...
  const btnOut: React.CSSProperties = { height: 52, fontSize: 15, fontWeight: 500, borderRadius: 12, cursor: "pointer", flex: 1, border: "1px solid rgba(52,211,153,0.25)", background: "transparent", color: "var(--c-text)" };

  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", color: "var(--c-text)", display: "flex", flexDirection: "column" }}>
      <style>{`
        .occ-wrap { width: 90%; max-width: 640px; margin: 0 auto; padding: 48px 0 120px; flex: 1; display: flex; flex-direction: column; }

...
export default function Home() {
  return (
    <div style={{ maxWidth: 1120, margin: "0 auto", padding: "120px 24px 64px" }}>
      {/* Hero */}
      <div style={{ marginBottom: 100, textAlign: "center" }}>
        ...
        <p style={{
          ...
          fontWeight: 600, letterSpacing: "-0.02em", marginBottom: 48,
        }}>
      ...
      <div style={{
        ...
        gap: 48, marginBottom: 80, textAlign: "center",
      }}>

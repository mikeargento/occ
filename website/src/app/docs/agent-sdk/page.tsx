  ...
  return (
    <article className="prose-doc">
      ...
      <div className="code-block">
        ...
        <pre className="text-xs font-mono leading-relaxed text-[#1f2937] overflow-x-auto">{`npm install occ-agent`}</pre>
      </div>
      ...
      <div className="code-block">
        ...
        <pre className="text-xs font-mono leading-relaxed text-[#1f2937] overflow-x-auto">{`import { wrapTool, fetchUrlTool } from "occ-agent";
...
result.occProof;          // portable OCC proof`}</pre>
      ...
      <ol className="space-y-2 text-sm text-[#1f2937] mb-6">
      ...
      <div className="code-block">
        <div className="code-block-header"><span>TypeScript</span></div>
        <pre className="text-xs font-mono leading-relaxed text-[#1f2937] overflow-x-auto">{`import { wrapTool } from "occ-agent";
...
// result.occProof - cryptographic proof of execution`}</pre>
      ...
      <div className="code-block">
        <div className="code-block-header"><span>TypeScript</span></div>
        <pre className="text-xs font-mono leading-relaxed text-[#1f2937] overflow-x-auto">{`import { runVerifiedTool, fetchUrlTool } from "occ-agent";
...
const result = await runVerifiedTool(
  ...
  { apiUrl: "https://nitro.occproof.com" },
      ...
      <div className="code-block">
        <div className="code-block-header"><span>TypeScript</span></div>
        <pre className="text-xs font-mono leading-relaxed text-[#1f2937] overflow-x-auto">{`import { exportReceipt, loadReceipt } from "occ-agent";
...
// receipt.proof    - the OCC proof`}</pre>
      ...
      <div className="code-block">
        <div className="code-block-header"><span>TypeScript</span></div>
        <pre className="text-xs font-mono leading-relaxed text-[#1f2937] overflow-x-auto">{`import { verifyExecutionReceipt, loadReceipt } from "occ-agent";
...
v.checks.signatureValid;    // Ed25519 signature valid`}</pre>
      ...
      <div className="code-block">
        ...
        <pre className="text-xs font-mono leading-relaxed text-[#1f2937] overflow-x-auto">{`{
  "type": "tool-execution",
  "tool": "fetch_url",
  "toolVersion": "1.0.0",
  ...
  "timestamp": 1773464119585
      ...
      <div className="overflow-x-auto mb-6">
        <table>
          <thead>
            <tr>
              <th className="text-left text-xs font-semibold text-[#1f2937] uppercase tracking-wide pb-3 pr-6">Parameter</th>
              <th className="text-left text-xs font-semibold text-[#1f2937] uppercase tracking-wide pb-3 pr-6">Type</th>
              <th className="text-left text-xs font-semibold text-[#1f2937] uppercase tracking-wide pb-3">Description</th>
            </tr>
          </thead>
      ...
      <div className="overflow-x-auto mb-6">
        <table>
          <thead>
            <tr>
              <th className="text-left text-xs font-semibold text-[#1f2937] uppercase tracking-wide pb-3 pr-6">Field</th>
              <th className="text-left text-xs font-semibold text-[#1f2937] uppercase tracking-wide pb-3 pr-6">Type</th>
              <th className="text-left text-xs font-semibold text-[#1f2937] uppercase tracking-wide pb-3">Description</th>
            </tr>
          </thead>

...
const sections = [
  ...
  { id: "sec-convergent-witnessing", num: "9.7", title: "Convergent Independent Witnessing", indent: true },
  { id: "sec-security-properties", num: "9.8", title: "Security Properties", indent: true },

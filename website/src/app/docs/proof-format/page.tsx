...
export default function ProofFormatPage() {
  return (
    <article className="prose-doc">
      ...
      <p className="text-[#1f2937] mb-10">
        Normative specification for the <code className="text-xs font-mono bg-[#d1d5db] px-1.5 py-0.5">bitgraph/1</code> proof format. Derived from the reference implementation.
      </p>
  ...
  "claims": { }                      // OPTIONAL - NOT signed, advisory
      ...
      <p className="text-[#1f2937] mb-4">
        The Ed25519 signature covers the canonical serialization of a <code className="text-xs font-mono bg-[#d1d5db] px-1.5 py-0.5">SignedBody</code> object:
      </p>
  ...
  attestationFormat: proof.environment.attestation?.format  // when present
      ...
      <ol className="space-y-2 mb-6 text-sm text-[#1f2937]">
        ...
        <li>2. Serialize with <code className="text-xs font-mono bg-[#d1d5db] px-1">JSON.stringify()</code> -- no whitespace</li>

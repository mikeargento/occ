...
import { useProxyEvents } from "@/lib/agent/use-events";
import type {
  AgentInstance,
...
import { formatCents, formatNumber, formatRelativeTime } from "@/lib/agent/format";
...
export default function AgentDetailPage() {
  ...
  if (loading) {
    return (
      <>
        <div className="h-8 w-48 mb-6 bg-bg-elevated rounded animate-pulse" />
        <div className="h-[400px] rounded-xl bg-bg-elevated border border-border animate-pulse" />
      </>
    );
  }

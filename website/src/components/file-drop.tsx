...
export function FileDrop({
  ...
  return (
    <div
      ...
      className={`
        h-full relative rounded-xl border transition-all duration-300 cursor-pointer min-h-[180px] flex items-center
      ...
      {multiple && files && files.length > 0 ? (
        <div className="w-full px-4 py-3">
          ...
          <div className="space-y-0.5 max-h-[240px] overflow-y-auto">
            {files.map((f, i) => (
              <div key={`${f.name}-${i}`} className="flex items-center justify-between py-2 px-3 rounded-lg hover:bg-bg-subtle/50 group transition-colors">

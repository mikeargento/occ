    ...
    <div>
      ...
      <nav className="topnav">
        ...
        <div className="topnav-links">
          ...
          <button className="topnav-link" onClick={() => setView(view === "settings" ? "main" : "settings")} style={{ fontWeight: view === "settings" ? 500 : 400, color: view === "settings" ? "var(--text)" : undefined }}>

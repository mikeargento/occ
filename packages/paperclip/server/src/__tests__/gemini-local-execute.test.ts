...
describe("gemini execute", () => {
  it("passes prompt as final argument and injects paperclip env vars", async () => {
    ...
    try {
      ...
      expect(capture.argv.at(-1)).toContain("OCC Agent runtime note:");
      ...
      expect(invocationPrompt).toContain("OCC Agent runtime note:");
      expect(invocationPrompt).toContain("PAPERCLIP_API_URL");
      expect(invocationPrompt).toContain("OCC Agent API access note:");
